        ...
        <div class="ml-80 flex-1 p-6">
            <div class="container mx-auto mt-10">
                <div class="mx-auto max-w-7xl rounded-md p-5 shadow-sm">
                    <h1 class="mb-5 text-2xl font-bold">Categories List</h1>
                    ...
                    <div class="mb-4 flex justify-end">
                        <a href="{{ route('categories.create') }}" class="btn btn-primary"><svg class="h-6 w-6"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" d="M5 12h14m-7 7V5" />
                            </svg>Create New Category</a>
                    </div>

                    <div class="overflow-x-auto">
                        <table class="table-zbra table w-full">
                            <thead>
                                <tr>
